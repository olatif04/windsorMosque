    ...
    <table className="text-white mx-auto table-auto border-collapse border-none w-full">
      <thead>
        <tr className="text-center border border-mosqueGreen-dark">
          ...
          <th className="text-2xl md:text-5xl">Begins</th>
          <th className="text-2xl md:text-5xl">Jama&apos;ah</th>
          <th className="text-2xl md:text-5xl">Tomorrow</th>
        </tr>
      </thead>
      <tbody>
        {PrayerTimesArray.map((prayer, index) => (
          ...
          >
            ...
            <td className="text-xl md:text-2xl">
            ...
            <td className="font-bold text-xl md:text-2xl">
              <span
                className={
